...
#Region " Overrides "
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.Clear(BackColor)
        G.DrawLine(New Pen(Color.FromArgb(255, 119, 116)), New Point(0, 0), New Point(Width, 0))
        G.DrawRectangle(New Pen(Color.FromArgb(255, 118, 118)), MainRect)
    ...
    Protected Sub OnColorSchemeChanged() Handles Me.ColorSchemeChanged
        ...
        Select Case ColorScheme
            Case ColorSchemes.Dark
                ...
                AccentColor = Color.FromArgb(255, 118, 118)
        End Select
    End Sub
    Private _AccentColor As Color
    Public Property AccentColor() As Color
...
#Region "Declarations"
    ...
    Private _BorderColour As Color = Color.FromArgb(255, 118, 118)
    ...
    Private _PressedColour As Color = Color.FromArgb(255, 118, 118)
        ...
        With g
            ...
            Select Case _Style
                Case Styles.Normal
                    ...
                    .DrawRectangle(New Pen(New SolidBrush(Color.FromArgb(255, 118, 118)), 2), New Rectangle(0, 0, Width, Height))
            End Select
            .InterpolationMode = CType(7, InterpolationMode)
        End With
    End Sub
...
#Region "Declarations"
    ...
    Private _CheckedColour As Color = Color.FromArgb(255, 118, 119)
    Private _BorderColour As Color = Color.FromArgb(255, 118, 118)
...
#Region "Declarations"
    Private _Checked As Boolean
    Private State As MouseState = MouseState.None
    Private _CheckedColour As Color = Color.FromArgb(255, 118, 118)
    Private _BorderColour As Color = Color.FromArgb(255, 118, 118)
        ...
        With g
            ...
            Select Case State
                Case MouseState.Over
                    ...
                    .DrawRectangle(New Pen(_BorderColour), New Rectangle(1, 1, 11, 18))
            End Select
            If Checked Then
    ...
    Sub ReplaceItem(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DrawItemEventArgs) Handles Me.DrawItem
        ...
        Try
            ...
            Else
                Select Case ColorScheme
                    Case ColorSchemes.Dark
                        e.Graphics.FillRectangle(New SolidBrush(Color.FromArgb(255, 118, 118)), e.Bounds)
                End Select
            End If
            Select Case ColorScheme
                Case ColorSchemes.Dark
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Select Case ColorScheme
            Case ColorSchemes.Dark
                G.Clear(Color.FromArgb(255, 118, 118, 167))
                G.DrawLine(New Pen(Color.FromArgb(255, 118, 118)), New Point(Width - 18, 10), New Point(Width - 14, 14))
                G.DrawLine(New Pen(Color.FromArgb(255, 118, 118)), New Point(Width - 14, 14), New Point(Width - 10, 10))
                G.DrawLine(New Pen(Color.FromArgb(255, 118, 118)), New Point(Width - 14, 15), New Point(Width - 14, 14))

        End Select
        G.DrawRectangle(New Pen(Color.FromArgb(255, 118, 118)), New Rectangle(0, 0, Width - 1, Height - 1))
...
#Region "Declarations"
    Private _ProgressColour As Color = Color.FromArgb(255, 119, 116)
    Private _BorderColour As Color = Color.FromArgb(255, 118, 118)
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        For i = 0 To TabCount - 1
            ...
            If i = SelectedIndex Then
                ...
                G.DrawLine(New Pen(Color.FromArgb(255, 119, 116)), New Point(mainRect.X, mainRect.Y + 25), New Point(mainRect.X + mainRect.Width - 0, mainRect.Y + 25))
